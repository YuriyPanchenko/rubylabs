...
class StudentInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_info" do
    assert_difference('StudentInfo.count') do
      post student_infos_url, params: { student_info: { address: @student_info.address, phone: @student_info.phone } }
    end
  ...
  test "should update student_info" do
    patch student_info_url(@student_info), params: { student_info: { address: @student_info.address, phone: @student_info.phone } }
